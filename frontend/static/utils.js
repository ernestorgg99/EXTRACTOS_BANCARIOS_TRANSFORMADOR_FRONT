...
/**
 * Función auxiliar para limpiar comas y normalizar espacios de una cadena.
 * @param {string} label La cadena a limpiar.
 * @returns {string} La cadena limpia y con espacios normalizados.
 */
export const cleanLabelForStructure2 = (label) => {
    if (typeof label === 'string') {
        // Elimina comas, normaliza todos los tipos de espacios a un solo espacio,
        // y luego recorta los espacios iniciales y finales.
