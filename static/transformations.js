...
const processBancoTesoro = (data, diario) => {
    ...
    const rows = data.slice(headerRowIndex + 1).map(row => {
        ...
        const patrones = ["LQ TDD 87949028", "COM/LIQ/TDD 87949028", "LQ TDC 87949028", "COM/LIQ/TDC 87949028", "DB TDD 87949028", "LQ ELE 87949028", "COM/LIQ/ELE 87949028", "COM. ASIGNACION MCD CORPORATIV", "BELOW MINIMUM BALANCE CHARGES"];
